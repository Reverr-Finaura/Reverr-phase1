export const courseDataEquityAndEverything = {
    frontscreen: {
      images: [
    ...
    modules: [
      ...
      },
     {
        ...
        image:'https://firebasestorage.googleapis.com/v0/b/reverr-25fb3.appspot.com/o/courses%2FCompetitorAnalysis%2FMarketing.png?alt=media&token=87446859-8650-4219-9c99-3e5ec1ab528b&_gl=1*xu724f*_ga*MTg2ODEyMzkyOS4xNjcwMzkyOTY5*_ga_CW55HF8NVT*MTY4NTc5Mjc1OS4yNC4xLjE2ODU3OTMxODYuMC4wLjA.',
        type: 'headtextimgpoints',
      },
      {
     ...
     
      {
        ...
        image:'https://firebasestorage.googleapis.com/v0/b/reverr-25fb3.appspot.com/o/courses%2FCompetitorAnalysis%2FChecklist.png?alt=media&token=703035c3-6c38-4589-8ada-b505e6928eef&_gl=1*10dq4ve*_ga*MTg2ODEyMzkyOS4xNjcwMzkyOTY5*_ga_CW55HF8NVT*MTY4NTgxNjQxMS4yNS4xLjE2ODU4MTY0MjIuMC4wLjA.',
         type: 'headtextimgpoints',
      },
      {
        question: 'What are some specific barriers to entry for your competitors?',
        options: [
          ' Technology Needed',
...
{
    question: 'When it comes to price, going downward might be detrimental to your business for a long time.',
    options: [
      'True',
      'False'
    ],
