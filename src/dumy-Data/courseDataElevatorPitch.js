export const courseDataElevatorPitch = {
    frontscreen: {
      images: [
    ...
    modules: [
     {
      ...
      {
        question: '_________is a slang term used to describe a brief speech that outlines an idea for a product, service, or project.',
        options: [
          'Elevator Pitch',
      ...
      {
        question: 'In which of the following case Elevator Pitch can be used?',
        options: [
...
slides:[
...

      {
...

        {
            ...
            {
                question: ' _______ encapsulates the market share you feel your product/service has the capacity to reach.',
                options: [
                  'Served Addressable Market',
                  'Total Addressable Market',
                  'Target Market',
...

{
  ...
  {
    question: 'Select the steps involved in writing the elevator pitch.    ',
    options: [
      'Reach to investors',
      'Identify the TAM',
      'Both A and B',
