  ...
  const AddedMentors = props => {
    ...
    return (
      <View style={styles.screen}>
        ...
        (<View style={{justifyContent:'center',alignContent:'center',alignItems:'center',marginTop:200}}>
            <Text style={{color:'grey'}}>No mentor is Present.</Text>
            <Text style={{color:'grey'}}>Plese Go through mentors subscription plans.</Text>
