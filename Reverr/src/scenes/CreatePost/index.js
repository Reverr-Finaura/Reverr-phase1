import {
  ...
  import { AddCameraImage,AddCameraVideo,AddGalleryImage,AddGalleryVideo } from '../../utils/FirebaseFunctionality';
      ...
      <View style={styles.screen}>
        ...
        <View style={styles.mainContainer}>
          <View style={styles.card}>
            ...
            {imageUrl? <View>
                <Image style={{width:100,height:100,margin:20,resizeMode:'cover'}} source={{uri:imageUrl}}/>
            </View>:null}
            {videoUrl? <View>
                <Video style={{width:100,height:100,margin:20,resizeMode:'cover'}} source={{uri:videoUrl}}/>
            </View>:null}
            <TextInput
              style={styles.msg}
              multiline={true}
