    ...
    <ScrollView style={styles.screen}>
      ...
      <View style={styles.privacyContainer}>
        ...
        <Text style={styles.details}>
          ...
          https://reverrapp.com/ and other offline sources. This Privacy Policy
          ...
          this Privacy Policy. Reverrapp.com is a property of DSquare Ventures
          LLP, an Indian Company registered under the Companies Act, 2013 having
          its registered office at 601, GDITL Northex Tower, Netaji Subhash
          place, Pitam pura, Delhi- 110034
        </Text>
        <Text
          style={[styles.heading, {textAlign: 'auto', paddingVertical: '7%'}]}>
        ...
        <Text style={styles.details}>
          ...
          when you buy a ticket. We NEVER collect your credit card number or
        ...
        <Text style={styles.details}>
          ...
          a third-party social media site belonging to Reverrapp.com.
        </Text>
        <Text style={styles.details}>
          <Text
            style={[
        ...
        <Text
          style={[styles.heading, {textAlign: 'auto', paddingVertical: '2%'}]}>
        ...
        <Text style={styles.details}>
          ...
          you can also email us at reverrapp.com
        </Text>
        <Text
          style={[styles.heading, {textAlign: 'auto', paddingVertical: '2%'}]}>
        ...
        <Text style={styles.details}>
          This Privacy Policy was last updated on 04.01.2022. From time to time
      ...
      <View style={{marginTop: '5%', paddingHorizontal: '2%'}}>
        ...
        <Text style={styles.details}>
          ...
          this website https://reverrapp.com/ (the "Website"), DSquare Ventures
          LLP offer of products for purchase on this Website, or your purchase
          of products available on this Website. This Agreement includes, and
          incorporates by this reference, the policies and guidelines referenced
          below. DSquare Ventures LLP reserves the right to change or revise the
          terms and conditions of this Agreement at any time by posting any
          changes or a revised Agreement on this Website. DSquare Ventures LLP
          ...
          of any such changes or revisions. DSquare Ventures LLP encourages you
          ...
          conditions of any other written agreement you may have with DSquare
          Ventures LLP for other products or services. If you do not agree to
          this Agreement (including any referenced policies or guidelines),
          please immediately terminate your use of the Website. If you would
          like to print this Agreement, please click the print button on your
          browser toolbar.
        </Text>
        <Text
          style={[styles.details, {fontFamily: 'Poppins-Bold', fontSize: 18}]}>
          I. PRODUCTS
        </Text>
        <Text style={styles.details}>
        ...
        <Text style={styles.details}>
          ...
          Ventures LLP sales reps, while they are calling you, of your desire to
          ...
          solicitations DSquare Ventures LLP and its designated in house or
        ...
        <Text style={[styles.details, {paddingVertical: 0}]}>
          3. You may send a written remove request to 601, GDITL Northex Tower,
          Netaji Subhash place, Pitam pura, Delhi- 110034.
        </Text>
        <Text style={styles.details}>
          Proprietary Rights. DSquare Ventures LLP has proprietary rights and
          trade secrets in the Products. You may not copy, reproduce, resell or
          redistribute any Product manufactured and/or distributed by DSquare
          Ventures LLP. DSquare Ventures LLP also has rights to all trademarks
          and trade dress and specific layouts of this webpage, including calls
        ...
        <Text style={styles.details}>
          ...
          provided solely as a convenience to you. DSquare Ventures LLP does not
          endorse the contents on any such third-party websites. DSquare
          Ventures LLP is not responsible for the content of or any damage that
          may result from your access to or reliance on these third-party
          websites. If you link to third-party websites, you do so at your own
          risk. Use of Website; DSquare Ventures LLP is not responsible for any
          damages resulting from use of this website by anyone. You will not use
          the Website for illegal purposes. You will (1) abide by all applicable
          ...
          written authorization from DSquare Ventures LLP or the applicable
          third party (if third party content is at issue). Posting. By posting,
          storing, or transmitting any content on the Website, you hereby grant
          DSquare Ventures LLP a perpetual, worldwide, non-exclusive,
          ...
          or hereinafter created, anywhere in the world. DSquare Ventures LLP
          ...
          post. DSquare Ventures LLP is not liable for any damage or harm
          resulting from any posts by or interactions between users. DSquare
          Ventures LLP reserves the right, but has no obligation, to monitor
          interactions between and among users of the Website and to remove any
          content DSquare Ventures LLP deems objectionable, in MuscleUP
        ...
        <Text style={styles.details}>
          ...
          BASIS. DSquare Ventures LLP EXPRESSLY DISCLAIMS ALL WARRANTIES OF ANY
          ...
          INFORMATION THAT IS ACCURATE, RELIABLE, COMPLETE, OR TIMELY. NO ADVICE
          OR INFORMATION, WHETHER ORAL OR WRITTEN, OBTAINED BY YOU FROM THIS
          WEBSITE WILL CREATE ANY WARRANTY NOT EXPRESSLY STATED HEREIN. AS TO
          THE RESULTS THAT MAY BE OBTAINED FROM THE USE OF THE PRODUCTS OR THAT
          DEFECTS IN PRODUCTS WILL BE CORRECTED. REGARDING ANY PRODUCTS
          PURCHASED OR OBTAINED THROUGH THE WEBSITE. SOME JURISDICTIONS DO NOT
        ...
        <Text style={styles.details}>
          ...
          LAW, IN EQUITY, OR OTHWERWISE, WITH RESPECT TO THE WEBSITE CONTENT AND
          PRODUCTS AND/OR FOR ANY BREACH OF THIS AGREEMENT IS SOLELY LIMITED TO
          THE AMOUNT YOU PAID, LESS SHIPPING AND HANDLING, FOR PRODUCTS
          PURCHASED VIA THE WEBSITE. DSquare Ventures LLP WILL NOT BE LIABLE FOR
          ...
          SUBSTITUTE PRODUCTS OR CONTENT; (3) ANY PRODUCTS PURCHASED OR OBTAINED
          OR TRANSACTIONS ENTERED INTO THROUGH THE WEBSITE; OR (4) ANY LOST
          PROFITS YOU ALLEGE. SOME JURISDICTIONS DO NOT ALLOW THE LIMITATION OR
        ...
        <Text style={styles.details}>
          You will release, indemnify, defend and hold harmless DSquare Ventures
          LLP, and any of its contractors, agents, employees, officers,
          ...
          fees and expenses, of third parties relating to or arising out of (1)
          ...
          supplied to DSquare Ventures LLP. When DSquare Ventures LLP is
          threatened with suit or sued by a third party, DSquare Ventures LLP
          may seek written assurances from you concerning your promise to
          indemnify DSquare Ventures LLP; your failure to provide such
          assurances may be considered by DSquare Ventures LLP to be a material
          breach of this Agreement. DSquare Ventures LLP will have the right to
          ...
          DSquare Ventures LLP choice at its expense. DSquare Ventures LLP will
          ...
          DSquare Ventures LLP against any claim, but you must receive DSquare
          Ventures LLP prior written consent regarding any related settlement.
        ...
        <Text style={styles.details}>
          DSquare Ventures LLP believes strongly in protecting user privacy and
          providing you with notice of MuscleUP Nutrition 's use of data. Please
          refer to DSquare Ventures LLP privacy policy, incorporated by
        ...
        <Text style={styles.details}>
          ...
          armed conflict, labor strike, lockout, or boycott. Cessation of
          Operation. DSquare Ventures LLP may at any time, in its sole
          discretion and without advance notice to you, cease operation of the
          Website and distribution of the Products. Entire Agreement. This
          Agreement comprises the entire agreement between you and DSquare
          Ventures LLP and supersedes any prior agreements pertaining to the
          subject matter contained herein. Effect of Waiver. The failure of
          DSquare Ventures LLP to exercise or enforce any right or provision of
          ...
          this Agreement remain in full force and effect. Governing Law;
          Jurisdiction. This Website originates from the Delhi.This Agreement
          will be governed by the laws of the State of [Law State Name] without
          regard to its conflict of law principles to the contrary. Neither you
          nor DSquare Ventures LLP will commence or prosecute any suit,
          ...
          courts located in State of Delhi. By using this Website or ordering
          ...
          by reason of this Agreement. You hereby waive any right to trial by
          jury arising out of this Agreement and any related documents. Statute
          of Limitation. You agree that regardless of any statute or law to the
          contrary, any claim or cause of action arising out of or related to
          use of the Website or Products or this Agreement must be filed within
          one (1) year after such claim or cause of action arose or be forever
          barred. Waiver of Class Action Rights. BY ENTERING INTO THIS
          AGREEMENT, YOU HEREBY IRREVOCABLY WAIVE ANY RIGHT YOU MAY HAVE TO JOIN
          CLAIMS WITH THOSE OF OTHER IN THE FORM OF A CLASS ACTION OR SIMILAR
          PROCEDURAL DEVICE. ANY CLAIMS ARISING OUT OF, RELATING TO, OR
          CONNECTION WITH THIS AGREEMENT MUST BE ASSERTED INDIVIDUALLY.
          Termination. DSquare Ventures LLP reserves the right to terminate your
          ...
          use the Website and DSquare Ventures LLP may, in its sole discretion
          and without advance notice to you, cancel any outstanding orders for
          Products. If your access to the Website is terminated, DSquare
          Ventures LLP reserves the right to exercise whatever means it deems
          necessary to prevent unauthorized access of the Website. This
          Agreement will survive indefinitely unless and until DSquare Ventures
          LLP chooses, in its sole discretion and without advance to you, to
          terminate it. Domestic Use. DSquare Ventures LLP makes no
          representation that the Website or Products are appropriate or
          available for use in locations outside India. Users who access the
          Website from outside India do so at their own risk and initiative and
          must bear all responsibility for compliance with any applicable local
          laws. Assignment. You may not assign your rights and obligations under
